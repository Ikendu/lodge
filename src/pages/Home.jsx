        ...
        <div className="relative z-10 w-full max-w-5xl px-4 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl mt-8 mx-auto">
            ...
            >
              ...
              />
              <h4 className="text-2xl font-bold mb-2">List a room</h4>
              <p className="text-sm md:text-base opacity-90">
                List your room in 5 minutes and earn extra income every week.
              </p>
            ...
            >
              ...
              <p className="text-sm md:text-base opacity-90">
                Find affordable lodges and guest houses starting from ₦4000 and
                book without delay.
              </p>
